	...
	<div class="breadcrumbs-inner">
		<div class="container">
			<ul class="breadcrumb">
            	...
            	<li class="breadcrumb-separator"><i class="icon-chevron-right icon-blue"></i></li> 
            	<li>Default CRF Theme Templates</li>
            </ul>
		</div>
	</div>
</div>
			...
			<div class="crf-header clearfix">
				<div class="pull-right">
					...
					<form class="form-search">
				      	<input type="text" class="input-medium search-query" placeholder="Search CRF Themes…">
				      	<button type="submit" class="btn">Search</button>
					</form>
					
				</div>
				<h3>Default CRF Theme Templates</h3>
			</div>
		</div>
	</div>
		...
		<div class="span9">
			...
			<div class="widget">
				<div class="widget-content">
					...
					<h3 class="content-title">View Default CRF Theme Templates</h3>
					
					<button class="btn" data-toggle="collapse" data-target="#filter-block">Filter Themes</button>
					...
					<div class="pagination-block clearfix">
						<span class="page-amount">Showing 1-9 of 34 Default CRF Theme Templates</span>
...
<div id="deleteModal" class="modal hide fade">
	...
	<div class="modal-body">
		<h4>You are deleting this Theme...</h4>
		<p>Theme name</p>
...
<div id="duplicateModal" class="modal hide fade">
	...
	<div class="modal-body">
		<h4>You are duplicating this Theme...</h4>
		<p>Theme name</p>
		<p>You will need to rename it, so it can be added to the Custom Theme library.</p>
		<form class="form-horizontal">
		  	<fieldset>
		    	<div class="control-group">
		      		<label class="control-label" for="input01">New Theme name</label>
		      		<div class="controls">
