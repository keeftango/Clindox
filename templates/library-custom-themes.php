	...
	<div class="breadcrumbs-inner">
		<div class="container">
			<ul class="breadcrumb">
            	...
            	<li class="breadcrumb-separator"><i class="icon-chevron-right icon-blue"></i></li> 
            	<li>Custom CRF Theme Templates</li>
            </ul>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="span12">
			<div class="crf-header clearfix">
				...
				<h3>Custom CRF Theme Templates</h3>
			</div>
		</div>
	</div>
		...
		<div class="span9">
			...
			<div class="widget">
				<div class="widget-content">
					...
					<h3 class="content-title">View Custom CRF Theme Templates</h3>
					...
					<div class="pagination-block clearfix">
						<span class="page-amount">Showing 1-9 of 34 Custom CRF Theme Templates</span>
