			...
			<div class="crf-header clearfix">
				...
				<div class="signup-steps step-1 clearfix">
					<ol>
						...
						<li class="step-43">Step 4 - CRF Created</li>
					</ol>
				</div>
		...
		<div class="span9">
			...
			<div class="widget">
				<div class="widget-content">
					...
					<p class="required-text">* indicates fields required</p>
					 <form class="form-horizontal">
					 	<fieldset>
					    	<div class="control-group">
						    	<label class="control-label" for="select-crf">CRF Type<span class="required">*</span></label>
						    	<div class="controls">
							...
							<div class="control-group">
						    	<label class="control-label" for="input01">CRF ID<span class="required">*</span></label>
						    	<div class="controls">
							...
							<div class="control-group">
						    	<label class="control-label" for="input02">CRF Title<span class="required">*</span></label>
						    	<div class="controls">
							    	<input type="text" class="input-xlarge" id="input02">
							    </div>
							</div><!-- /.control-group -->
							<div class="control-group">
						    	<label class="control-label" for="header-content">Header Content<span class="required">*</span></label>
						    	<div class="controls">
							...
							<div class="control-group">
						    	<label class="control-label" for="footer-content">Footer Content<span class="required">*</span></label>
						    	<div class="controls">
							...
							<div class="control-group">
						    	<label class="control-label" for="title-page">Title Page<span class="required">*</span></label>
						    	<div class="controls">
					  	...
					  	<div class="tab-pane active" id="theme">
					  		<ul class="thumbnails ">
						   		<li class="file-thumbnail">
						     		<div class="thumbnail">
						       		<img alt="placeholder image" src="http://placehold.it/201x160" alt="">
						       		<div class="caption">
					         			<h5>File title</h5>
						       		</div><!-- /.caption -->
						     		</div><!-- /.thumbnail -->
